...
const Reviews = () => {
  return (
    <div className="contain">
      <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 dark:bg-gray-50 dark:text-gray-800 mx-auto mt-10">
	<div className="flex flex-col w-full">
		...
		<p className="text-sm dark:text-gray-600">2145 global ratings</p>
